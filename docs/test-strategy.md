...
| NFR-01: Performance      | crypto::bench            | —                 | —                   |
| NFR-06: Sicherheit       | parser::input_validation | —                 | cli invalid input   |
| NFR-09: Fehlerbehandlung | error::display           | parse_invalid::*  | cli error cases     |
